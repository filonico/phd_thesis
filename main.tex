...
\usepackage[labelfont=bf, font={small,sf,singlespacing}, labelsep=endash]{caption}
...
\crefmultiformat{figure}{\textbf{Fig.~#2#1#3}}{\textbf{ and #2#1#3}}{\textbf{, #2#1#3}}{\textbf{, and #2#1#3}}  % cref format for multi-ref figures
\crefmultiformat{table}{\textbf{Tab.~#2#1#3}}{\textbf{ and #2#1#3}}{\textbf{, #2#1#3}}{\textbf{, and #2#1#3}}   % cref format for multi-ref tables
