...
% define new command to insert blank white space
\def\blankpage{%
      \clearpage%
      \thispagestyle{empty}%
      \addtocounter{page}{-1}%
...
% prevent the book class to add vertical spacing to fit the text to the page
\raggedbottom
...
% define the style of doublepage as empty
...
\newgeometry{% total={17cm,24cm},
  inner=3cm, outer=2cm, top=2.7cm, bottom=2.5cm,
...
% page style for chapter page: no header, but include footer with number
\fancypagestyle{plain}{%
  \fancyfoot[LE,RO]{\thepage}
}

\renewcommand{\headrulewidth}{0.2pt} % remove head ruler
\renewcommand{\chaptermark}[1]{\markboth{#1}{}} % set leftmark style of chapters
\fancyhead{} % clear header
\fancyfoot{} % clear footer
\fancyhead[LE,RO]{\textsl{\nouppercase{\leftmark}}} % % set the same header on both odd and even pages
\fancyfoot[LE,RO]{\thepage} % set page numbering
...
\include{sections/aknowledgements}
\cleardoublepage
...
\fancyhead[LE]{\textsl{\nouppercase{\chaptername{} \thechapter}}} % set even page header
