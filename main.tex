...
% packages for chemical formulae and special symbol
\usepackage{mhchem}
\usepackage{textcomp}

% packages and commands for glossaries
\usepackage[acronym, nonumberlist, toc, nomain, nogroupskip, nopostdot, shortcuts, style=super]{glossaries}
\makeglossaries
\loadglsentries{sections/abbreviations}
\renewcommand{\glsnamefont}[1]{\textbf{#1}} % make entries in list bold
\preto\chapter{\glsresetall} % reset glossary every chpater
