...
\subsection{Sample collection, MitoTracker staining and fixation} \label{rearing_MM}
...
\subsection{mRNA \textit{in-situ} Hybridization Chain Reaction (HCR)} \label{hcr_MM}
...
\subsection{Immunolocalization of Vasa} \label{immuno}
