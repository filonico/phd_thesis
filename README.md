...
In this repository you can find my final PhD thesis, together with the $$\small \text{Font size is small, eg. $\sum{x_i = 10}$}$$ code used to generate it, high-resolution figures and a parsable version of tables.
